...
public class MapDemo {
    public static void main(String[] args) {
        ...
        // array of Object : any object works (not basic data type) Integer,
        // String Box, Employee . . .
        ...
        // Q1 a=10 b=12 c=4 d=4 s=2 e=4// create a frequency map for each
        // character
        ...
        // so answer is scdeab
        String string = "Am=<&^%$#n123";
        char first = string.charAt(0);
        boolean firstCond = Character.isUpperCase(first);
        string = string.substring(1);
        System.out.println(firstCond + "," + string.matches("[^A-Z]*"));
    }
}
