...
public class StringDemo2 {
	public static void main(String args[]) {
		...
		System.out.println(line.endsWith(word)); // "this".endsWith("hello")
													// False
		...
		/*
		 * int n = sc.nextInt(); String[] wordsAr = new String[n]; for(int i= 0;
		 * i<n; i++) { wordsAr[i] = sc.next(); }
		 */
		String[] wordsAr = line.split(" ");
...
// read a line, find how many words are in the line?
